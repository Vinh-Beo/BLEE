...
//            "000010101-0000-1000-8000-00805F9B34FB";
//
...
//    }
    ...
    public boolean writeCharacteristic(byte[] data)
    {
        ...
        BluetoothGattService Service = mBluetoothGatt.getService(UUID.fromString("0783b03e-8535-b5a0-7140-a304d2495cb7"));
        if (Service == null) {
            Log.e(TAG, "service not found!");
            return false;
        }
        BluetoothGattCharacteristic characteristic = Service
                .getCharacteristic(UUID.fromString("0783b03e-8535-b5a0-7140-a304d2495cba"));
